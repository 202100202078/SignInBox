...
const onSubmit = async (type) => {
  ...
  if (isLoginPage.value) {
    ...
    userStore.setToken(
      'eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjBmYjVmMWM4LTIwMmYtNDExZi05MDIxLWViY2I1Nzg1YmRkMSJ9.gpQ-eM6HwIhGHDcbWZ7MxzB5KCCPzGWGc59q95A4iD-vkaq7OvpWTwdlWvOSdlnBvIFk_3e9s6YZIpsX77Sxpg'
    )
    // 清空表单
