...
const onSubmit = async (type) => {
  ...
  if (isLoginPage.value) {
    ...
    userStore.setToken(
      'eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjZhMDE0YWFkLTQyNDItNGU1ZC05NTI3LTk0NzUxOWRiYWQxMCJ9.lIY-tC8W63MXlm_mgB7dDA8YSsi2bipDF0GkGHSv5FxgSSUqlvWP7L7EALKMG0mB8KGwbIuagXmQMWLqzVrEaQ'
    )
    // 清空表单
