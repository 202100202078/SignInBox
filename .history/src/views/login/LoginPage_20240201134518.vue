...
const onSubmit = async (type) => {
  ...
  if (isLoginPage.value) {
    ...
    userStore.setToken(
      'eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjAzMmI1ODU0LTVmZWEtNDNjNC05YTA5LWRlM2QzZWYxNGUzNCJ9.6T346yZ9v_NeFHc9k61N_3qm1k9xjnsAyMQvys6QclRuxrDP77YwrE0Fvj-tjXJLjwbtKZd8tjAdgD1ATHm6DQ'
    )
    // 清空表单
    ...
    <el-container>
      ...
      <el-main>
        ...
        >
          ...
          <div class="other">其他登录方式：1、2、3(待实现)</div>
        </el-tabs>
      </el-main>
      <el-footer>
