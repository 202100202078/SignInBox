...
<template>
  ...
  <div class="user-managemant-page">
    ...
    >
      ...
      <el-table-column property="userId" label="用户编号" width="120" />
      <el-table-column property="uname" label="用户名称" width="120" />
      <el-table-column property="nickName" label="用户昵称" width="120" />
      ...
      <el-table-column property="createDate" label="创建时间" width="120" />
      <el-table-columnlabel ="操作" show-overflow-tooltip />
    </el-table>
  </div>
</template>
