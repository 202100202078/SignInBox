...
<template>
  <MyDialog :title="title" ref="myDialogRef"></MyDialog>
  ...
  <div class="user-managemant-page">
    ...
    <div class="user-managemant-page-btns">
      <el-button plain type="primary" @click="addUser">添加</el-button>
      <el-button plain type="success" @click="editUser">修改</el-button>
