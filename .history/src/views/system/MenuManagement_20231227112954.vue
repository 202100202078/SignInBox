...
<template>
  <div class="menu-management-page">
    ...
    >
      <el-table-column width="" align="center" prop="menuName" label="菜单名称" />
      <el-table-column width="" align="center" prop="order" label="排序" />
      <el-table-column width="" align="center" prop="authority" label="权限标识" />
      <el-table-column width="" align="center" prop="comPath" label="组件路径" />
      <el-table-column width="" align="center" prop="state" label="状态">
        <template #default> 正常 </template>
      </el-table-column>
      <el-table-column width="" align="center" prop="createDate" label="创建时间" />
