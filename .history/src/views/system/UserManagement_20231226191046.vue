...
<template>
  ...
  <div class="user-managemant-page">
    ...
    >
      <el-table-column align="" type="selection" width="55" />
      <el-table-column align="" property="userId" label="用户编号" width="120" />
      <el-table-column align="" property="uname" label="用户名称" width="120" />
      <el-table-column align="" property="nickName" label="用户昵称" width="120" />
      <el-table-column align="" property="phone" label="手机号码" width="120" />
      <el-table-column align="" label="状态" width="120">
